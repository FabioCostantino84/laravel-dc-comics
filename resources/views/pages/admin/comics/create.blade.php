...
@section('main_content')
    <div class="container">
        ...
        <h1>Compila i campi per creare un nuovo fumetto</h1>
        ...
        <form action="{{ route('comics.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control @error('title') is-invalid @enderror" name="thumb"
                    id="thumb" placeholder="" aria-describedby="thumb_helper">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" name="price"
                    id="price" aria-describedby="helpId" placeholder="scrivi una descrizione">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="artists" id="artists" aria-describedby="helpId"
                    placeholder="scrivi una descrizione">
                <small id="artistsHelper" class="form-text text-muted">Scrivi gli artisti</small>
            </div>
            <div class="mb-3">
                <label for="writers" class="form-label">Scrittori</label>
                <input type="text" class="form-control" name="writers" id="writers" aria-describedby="helpId"
                    placeholder="scrivi una descrizione">
        ...
        <a class="btn btn-secondary text-white my-5 " href="{{ route('comics.index') }}" role="button">Torna
            indietro</a>
