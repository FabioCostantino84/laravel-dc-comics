            ...
            <div class="row">
                ...
                <div class="col d-flex flex-wrap">
                    ...
                    @foreach ($comics as $comic)
                        <div class="card w-25 m-2 p-5 text-decoration-none">
                            <a class="btn btn-primary " href="{{ route('comics.show', $comic->id) }}"
                                role="button">View</a>
                            <a class="btn btn-info text-white " href="{{ route('comics.create', $comic->id) }}"
                                role="button">Edit</a>

                            <form action="{{ route('comics.destroy', [$comic->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button class="btn btn-danger mb-3 border-0" type="submit">Delete</button>
                            </form>
